...
<!-- Modal-->
<div class="modal fade" id="modalPerfil" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('Perfil/guarda') }}" method="POST" id="formulario-tipos">
                	@csrf
                	<div class="row">

                		<div class="col-md-4">
                			<div class="form-group">
                			    <label for="exampleInputPassword1">Nombre del Perfil
                			    <span class="text-danger">*</span></label>
                			    <input type="hidden" class="form-control" id="perfil_id" name="perfil_id" />
	...
	<div class="card card-custom gutter-b">
		<div class="card-header flex-wrap py-3">
			<div class="card-title">
				<h3 class="card-label">TIPOS DE PERFILES
				</h3>
			</div>
			...
			<div class="table-responsive m-t-40">
				<table class="table table-bordered table-hover table-striped" id="tabla-insumos">
					...
					<tbody>
						...
						@empty
							<h3 class="text-danger">NO EXISTEN PERFILES</h3>
						@endforelse
					</tbody>
					<tbody>
					</tbody>
		...
		function elimina(id, nombre)
        {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    window.location.href = "{{ url('Perfil/elimina') }}/"+id;
