...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		    {{-- <meta name="csrf-token" content="v7TD87zAtTiNFroDmQvlpCeVAFzcj667otlpZVvg" /> --}}
        <meta name="csrf-token" content="{{ csrf_token() }}" />
		...
		<link href="http://kcb.test/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="http://kcb.test/assets/plugins/custom/prismjs/prismjs.bundle.css" rel="stylesheet" type="text/css" />
		<link href="http://kcb.test/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Global Theme Styles-->
		<!--begin::Layout Themes(used by all pages)-->
		<link href="http://kcb.test/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
		<link href="http://kcb.test/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
		<link href="http://kcb.test/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
		<link href="http://kcb.test/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />

		    <link href="http://kcb.test/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet">
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="http://kcb.test/assets/media/logos/favicon.ico" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="#">
				<img alt="Logo" src="http://kcb.test/assets/media/logos/logo-light.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
													...
													<li class="menu-item menu-item-parent" aria-haspopup="true">
														<span class="menu-link">
															<span class="menu-text">Ejemplares</span>
																																																				...
																																																				<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Ejemplar/listado" class="menu-link">
																		...
																		<span class="menu-text">Listado Ejemplares</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Ejemplar/formulario/0" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Nuevo Ejemplar</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Ejemplar/formularioCamada" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-parent" aria-haspopup="true">
														<span class="menu-link">
															<span class="menu-text">Usuarios</span>
																																																				...
																																																				<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/User/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Listado</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/User/listadoPropietario" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Propietario</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/User/listaPermisos" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-parent" aria-haspopup="true">
														<span class="menu-link">
															<span class="menu-text">Eventos</span>
																																																				...
																																																				<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Evento/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-parent" aria-haspopup="true">
														<span class="menu-link">
															<span class="menu-text">Administracion</span>
																																																				...
																																																				<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Raza/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Razas</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/CategoriasPista/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Categorías Pistas</span>
																	</a>
																</li>	
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Examen/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Examenes</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Grupo/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Grupos</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Pista/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Pistas</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/TiposUsuario/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Tipos Usuarios</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Titulo/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Titulos</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Sucursal/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Sucursales</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Perfil/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Perfiles</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Criadero/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Criadero</span>
																	</a>
																</li>	
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Alquiler/listado" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Alquileres</span>
																																																																							...
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Ejemplar/bitacora" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
													...
													<li class="menu-item menu-item-parent" aria-haspopup="true">
														<span class="menu-link">
															<span class="menu-text">Reportes</span>
																																																				...
																																																				<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Reporte/ejemplarporraza" class="menu-link">
																		<i class="menu-bullet menu-bullet-dot">
																			<span></span>
																		</i>
																		<span class="menu-text">Ejemplares por Raza</span>
																	</a>
																</li>	
																																																																							<li class="menu-item" aria-haspopup="true">
																	<a href="http://kcb.test/Alquiler/listado" class="menu-link">
								...
								<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
									...
									<ul class="menu-nav">
										<li class="menu-item menu-item-submenu menu-item-rel menu-item-active" data-menu-toggle="click" aria-haspopup="true">
											<span class="text-primary">{{ date('d')."/".date('m')."/".date('Y') }}</span>											
										</li>
									</ul>
									<!--end::Header Nav-->
								</div>
							...
							<div class="topbar">
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<form>
											<!--begin::Header-->
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(http://kcb.test/assets/media/misc/bg-1.jpg)">
												<!--begin::Title-->
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
										<!--begin:Header-->
										<div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(http://kcb.test/assets/media/misc/bg-1.jpg)">
								...
								<div class="dropdown">
									...
									<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
										<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
											<img class="h-20px w-20px rounded-sm" src="http://kcb.test/assets/media/svg/flags/226-united-states.svg" alt="" />
										</div>
									</div>
									<!--end::Toggle-->
									<!--begin::Dropdown-->
									<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
										...
										<ul class="navi navi-hover py-4">
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="http://kcb.test/assets/media/svg/flags/226-united-states.svg" alt="" />
													</span>
											...
											<li class="navi-item active">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="http://kcb.test/assets/media/svg/flags/128-spain.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="http://kcb.test/assets/media/svg/flags/162-germany.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="http://kcb.test/assets/media/svg/flags/063-japan.svg" alt="" />
													</span>
											...
											<li class="navi-item">
												<a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="http://kcb.test/assets/media/svg/flags/195-france.svg" alt="" />
													</span>
...
<script src="http://kcb.test/assets/plugins/global/plugins.bundle.js"></script>
<script src="http://kcb.test/assets/plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="http://kcb.test/assets/js/scripts.bundle.js"></script>
<script src="http://kcb.test/assets/js/pages/features/miscellaneous/sweetalert2.js"></script>
<script>
