        ...
        @if ($evento->habilitado == 'Si')
            ...
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Card-->
                    <div
                        class="card card-custom gutter-b example example-compact {{ $textBack }} {{ $textColor }}">
                        <br>
                        <div class="row">
                            @if ($evento->estado == 'Si')
                                <div class="col-md-3">
                            ...
                            @else
                                ...
                                <div class="col-md-4" style="">
                                    <div style="height: 100px;">
                                        {{-- <img src="{{ url('img/logo.png') }}" alt="" height="100%"> --}}
                                        <img src="{{ url('img/KCB_NEW.png') }}" alt="" height="100%">
                                    </div>
                                </div>
                                <div class="col-md-4" style="">
                                    <div style="height: 100px;">
                        ...
                        <!--begin::Form-->
                        <form action="{{ url('Evento/inscribirEvento') }}" method="POST"
                            id="formulario-inscripcion-evento" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-form-label">
                                                        <div class="radio-inline">
                                                            <label class="radio radio-success {{ $textColor }}">
                                                                <input type="radio" name="radios5" id="Nacional"
                                                                    checked="checked" value="Nacional"
                                                                    onchange="mostrarBusqueda()" />
                                                                <span></span>
                                                                Nacional
                                                            </label>
                                                            <label class="radio radio-success {{ $textColor }}">
                                                                <input type="radio" name="radios5" id="Extranjero"
                                                                    value="Extranjero" onchange="mostrarBusqueda()" />
                                                                <span></span>
                                                                Extranjero
                                                            </label>
                                                        </div>
                                                        <span class="form-text text-muted">Selecciona la nacionalidad o
                                                            Extranjero del Ejemplar</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                <label
                                                                    class="exampleInputPassword1 {{ $textColor }}">
                                                                    KCB
                                                                </label>
                                                                <input type="text" class="form-control"
                                                                    id="kcb_busca" name="kcb_busca" required />
                                                                <span class="form-text text-danger" id="msg-error-kcb"
                                                                    style="display: none;">Ejemplar no
                                                                    Registrado</span>
                                                                <span class="form-text text-success" id="msg-good-kcb"
                                                                    style="display: none;">Ejemplar Registrado</span>
                                                                <span class="form-text text-danger" id="msg-vacio-kcb"
                                                                    style="display: none;">Digitar un K.C.B.</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-9">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    id="cod_extrangero" name="cod_extrangero" />
                                                                <span class="form-text text-danger" id="msg-vacio-cod"
                                                                    style="display: none;">Digitar un Codigo de
                                                                    Extranjero</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="hidden" id="verdad_extrangero" name="verdad_extrangero"
                                                value="no">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="fecha_nacimiento"
                                                name="fecha_nacimiento" onchange="calcular_fecha()" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="registro_extrangero"
                                                name="registro_extrangero" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="exampleInputPassword1 {{ $textColor }}">
                                                Tatuaje</label>
                                            <input type="text" class="form-control" id="tatuaje"
                                                name="tatuaje" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="exampleInputPassword1 {{ $textColor }}">
                                                KCB del Padre</label>
                                            <input type="text" class="form-control" id="kcb_padre"
                                                name="kcb_padre" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom_padre"
                                                name="nom_padre" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="exampleInputPassword1 {{ $textColor }}">
                                                KCB del Madre</label>
                                            <input type="text" class="form-control" id="kcb_madre"
                                                name="kcb_madre" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom_madre"
                                                name="nom_madre" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="categoria_pista"
                                                name="categoria_pista" required onchange="subeCerfificado(this)">
                                                <option value=""></option>
                                                <div id="categoria">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="exampleInputPassword1 {{ $textColor }}">
                                                Criador</label>
                                            <input type="text" class="form-control" id="criador"
                                                name="criador" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="carnet" name="carnet"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-success btn-block"
                                            onclick="inscribir()">INSCRIBRI EJEMPLAR</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (let index = 0; index < categorias.length; index = index + 2) {
                        $('#categoria_pista').prepend("<option value='" + categorias[index] + "' >" +
                            categorias[index + 1] + "</option>");
                    }
