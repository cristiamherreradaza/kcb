						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="exampleInputPassword1">RAZA
									...
									<br>
								<select class="form-control select2" id="raza_buscar" style="width:100%;" name="raza_buscar">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="exampleInputPassword1">PROPIETARIO
									...
									<br>
								<select class="form-control select2" id="propietario_buscar" style="width:100%;" name="propietario_buscar">
