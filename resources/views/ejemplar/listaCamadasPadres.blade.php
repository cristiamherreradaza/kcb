	...
	<div class="card card-custom gutter-b">
		...
		<div class="card-body">
            {{-- <div class="row">
                ...
                <div class="col-md-2">
                    <h3>
                        <span class="text-primary">Camada: </span>{{ $camada->camada }}
                    </h3>
                </div>
            </div>
            <div class="row">
            ...
            @forelse ($camada as $c)
                <div class="row">
                    <div class="col-md-12">
                         <div class="row">
                            <div class="col-md-5">
                                <h3>
                                    <span class="text-primary">Padre: </span>{{ $c->padre->nombre_completo }}
                                </h3>
                            </div>
                            <div class="col-md-5">
                                <h3>
                                    <span class="text-primary">Madre: </span>{{ $c->madre->nombre_completo }}
                                </h3>
                            </div>
                            <div class="col-md-2">
                                <h3>
                                    <span class="text-primary">Camada: </span>{{ $c->camada }}
                                </h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <h3>
                                    <span class="text-primary">Raza: </span>{{ $c->raza->nombre }}
                                </h3>
                            </div>
                            <div class="col-md-6">
                                <h3>
                                    <span class="text-primary">Fecha de Nacimeinto: </span>{{ $c->fecha_nacimiento }}
                                </h3>
                            </div>
                        </div>
                    </div>
                ...
                <div class="table-responsive m-t-40">
                    <table class="table table-bordered table-hover table-striped" id="tabla-insumos">
                        ...
                        <tbody>
                            @php
                                $ejemplares = App\Ejemplar::where('camada_id',$c->id)->get();
                            @endphp
                            @forelse ($ejemplares as $ec)
                                <tr>
                                    <td>{{ $ec->id }}</td>
                                    <td>{{ $ec->kcb }}</td>
